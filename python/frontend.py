...
ctk.set_default_color_theme("python/high-contrast.json")
...
class App(ctk.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.browse_files = ctk.CTkButton(self.sidebar, text="Browse Files", command=self.tab_view.find_input_file, height = 50)
